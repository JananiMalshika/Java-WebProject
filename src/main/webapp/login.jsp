...
<head>
  ...
  <title>ROADMaster Admin Login Page</title>
...
<div class="w3-container">
	...
	<p class="welcome"><b>WELCOME TO ROADMaster!</b><br>  <b>Admin Login Page</b></p>

      <input type="text" class="uName" id="uName" placeholder="Username"><br>
      
      <input type="text" class="uName" id="pass" placeholder="Password"><br>
	
  	<select id="type" name="type">
	  	 <option value="select">Choose A Type</option>
	 ...
	 <br> 
	 <input type="submit"  class="subm" name="submit" id="subm" value="Login">
      <p class="forgot" ><a href="#"><u>Forgot Password?</u></a></p>
      <p class="reg">Don't have an account?<a href="userRegister.html"><u> Register</u></a></p>
