        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item @@about__active">
              <a class="nav-link" href="about.html">Reports</a>
            </li>
            <li class="nav-item @@services__active">
              <a class="nav-link" href="services.html">Fuel</a>
            </li>
			<li class="nav-item @@services__active">
              <a class="nav-link" href="services.html">Items</a>
            </li>
			<li class="nav-item @@services__active">
              <a class="nav-link" href="services.html">Payments</a>
            </li>
			<li class="nav-item @@services__active">
              <a class="nav-link" href="services.html">Service Dates</a>
            </li>
...
<br>
 ...
 <c:forEach var = "cus" items = "${uid}">
	...
	<c:set var="psw" value="${cus.password}"/>
...
<div class="form123">
	...
	<th></th>
          ...
          <label>Type :</label> <br>
          <input type="text" id="type" name="type" value ="${type}"> <br> <br> <br>
		...
		<input type ="submit" class="buttonf" name ="submit" value ="Search"> 
	 	<input type ="submit" class="buttonf" name ="submit" value ="Update"><br>
	 	<!--  <input type ="submit" class="buttonf" name ="submit" value ="Search"> 
	 	<input type ="submit" class="buttonf buttonredf" name ="submit" value ="Delete"> -->
	</form>
     ...
     <!--<input type ="submit" name ="submit" value ="Delete"> -->
       <!--  <input type ="submit" class="buttonf" name ="submit" value ="Search"> 
	 	<input type ="submit" class="buttonf" name ="submit" value ="Add">
	 	<input type ="submit" class="buttonf" name ="submit" value ="Update"> -->
	 	<input type ="submit" class="buttonf" name ="submit" value ="Add">
	 	<input type ="submit" class="buttonredf" name ="submit" value ="Delete">
       </form>
