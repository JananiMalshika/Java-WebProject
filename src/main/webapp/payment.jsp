      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
			...
			<li class="nav-item @@services__active">
              <a class="nav-link" href="#">Service Dates</a>
            </li>
                        ...
                        $('#horizontalTab').easyResponsiveTabs({
                            ...
                            fit: true   // 100% fit in a container
                                        ...
                                        <h3>Payment Information</h3><br>
                                                ...
                                                <h5>Payment Amount (Rs.)</h5>
                                                    <input type="text" name ="amount" value="">
                                                <h5>Payment Date</h5>													
                                                    <input type="date" name = "date" value="">
                                            			
                                        
                                        <br> <h3 class="pay-title">Credit Card Information</h3><br>
                                                ...
                                                <h5>Card Number</h5>													
                                                    ...
                                                    <h5>CVV Number</h5>													
                                                    <input type="text" value="xxxx" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'xxxx';}">
